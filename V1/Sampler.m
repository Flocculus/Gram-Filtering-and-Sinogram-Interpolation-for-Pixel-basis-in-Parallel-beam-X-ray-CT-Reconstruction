...
%     along with this program.  If not, see <http://www.gnu.org/licenses/>.
    ...
    methods
        function this = Sampler(xStart, xStep, xSize, upsampleRate, phi, varargin)
            this.name ='';             %
        ...
        function y = Apply(this,x)   
			...
			xUp = zeros(this.sizeout);
			xUp(1:this.upsampleRate:end, 1:this.upsampleRate:end, 1:this.upsampleRate:end) = x;
			
			y = this.phi.reconstruct(this.xStep/this.upsampleRate, xUp);
        ...
        function y = Adjoint(this,x)
			...
			yUp = this.phi.reconstruct(this.xStep/this.upsampleRate, x);
			y = yUp(1:this.upsampleRate:end, 1:this.upsampleRate:end, 1:this.upsampleRate:end);
